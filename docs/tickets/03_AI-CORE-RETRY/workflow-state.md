...
| **2.1** | Setup Thư mục, File & Dependency Injection (Depends) | ⬜ pending | `docs/features/03_AI-CORE-RETRY/implementation.md` | |
...
| **3.1** | Audit Type Hints (Mypy/Ruff) | ⬜ pending | `docs/testing/03_AI-CORE-RETRY/testing.md` | |
...
| **4.3** | Viết tài liệu Hướng dẫn Test tay (Manual Test) | ⬜ pending | `docs/tickets/03_AI-CORE-RETRY/manual_test.md` | |
...
- Việc cần làm tiếp theo: Bước 1.2
