...
| **2.1** | Setup Thư mục, File & Dependency Injection (Depends) | ⬜ pending | `docs/features/02_API-ASYNC/implementation.md` | |
...
| **3.1** | Audit Type Hints (Mypy/Ruff) | ⬜ pending | `docs/testing/02_API-ASYNC/testing.md` | |
