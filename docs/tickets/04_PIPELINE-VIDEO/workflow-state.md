...
| **2.1** | Setup Thư mục, File & Dependency Injection (Depends) | ⬜ pending | `docs/features/04_PIPELINE-VIDEO/implementation.md` | |
...
| **3.1** | Audit Type Hints (Mypy/Ruff) | ⬜ pending | `docs/testing/04_PIPELINE-VIDEO/testing.md` | |
...
| **4.3** | Viết tài liệu Hướng dẫn Test tay (Manual Test) | ⬜ pending | `docs/tickets/04_PIPELINE-VIDEO/manual_test.md` | |
