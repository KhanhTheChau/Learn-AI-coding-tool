...
**Ticket:** #01 — 01_PERSISTENCE — Khởi tạo Project & Thiết kế Ranh giới Lưu trữ
**Branch:** main
...
| **2.1** | Setup Thư mục, File & Dependency Injection (Depends) | ⬜ pending | `docs/features/01_PERSISTENCE/implementation.md` | |
...
| **3.1** | Audit Type Hints (Mypy/Ruff) | ⬜ pending | `docs/testing/01_PERSISTENCE/testing.md` | |
...
- Việc cần làm tiếp theo: Bước 1.2 Thiết kế Pydantic Schemas
